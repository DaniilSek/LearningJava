...
[14. Наследование и ключевое слово final](#14-расскажите-как-устроено-наследование-в-java-что-значит-ключевое-слово-final-применительно-к-классу-и-методу)
[15. Создание потоков (Thread vs Runnable)](#15-опишите-принцип-работы-многопоточности-в-java-чем-отличается-создание-потока-через-реализацию-интерфейса-runnable)
[16. Сериализация объектов](#16-что-такое-сериализация-объектов-в-java-и-для-чего-она-применяется-какой-инт)
[17. Аннотации в Java](#17-что-такое-аннотации-в-java-зачем-они-используются-приведите-пару-примеров-с)
[18. Жизненный цикл сервлета](#18-какой-цикл-управляет-жизненным-циклом-сервлетов-в-веб-приложениях-jav)
