...
[10. Виды исключений](#10-что-означает-термин-“исключение”-exception-в-java-какие-бывают-виды-исключений-и-к)  
...
[12. Collection: List и Set](#12-объясните-разницу-между-интерфейсами-collection-list-и-set-приведите-пример)  
