...
-   [1. Полиморфизм, абстракция, наследование, инкапсуляция](#1.-объясните-концепцию-полиморфизма-абстракции-наследования-и-инкапсуляции-в-Java-и-приведите-пример)
-   [20. Принципы SOLID](#20.-объясните-принципы-solid-и-приведите-примеры-на-java)
1. Полиморфизм, абстракция, наследование, инкапсуляция
2. Ключевое слово final
...
8. Класс Object
9. ==, equals() и compareTo()
10. Виды исключений
11. Сборщик мусора (GC)
12. Collection: List и Set
13. Дженерики (Generics)
14. Наследование и ключевое слово final
15. Создание потоков (Thread vs Runnable)
16. Сериализация объектов
17. Аннотации в Java
18. Жизненный цикл сервлета
19. Stream API
20. Принципы SOLID
